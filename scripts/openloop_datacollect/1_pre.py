...
def execution(pipeline_type, list_of_freq_lim, freq_limits_names_list, filt_orders, window_sizes, subject):
    ...
    folder_path = Path(f'.\scripts\cl\Expdata\Subjects\dry\{subject}\session1\openloop')
    result_path = Path(f'./data/openloop/intermediate_datafiles/preprocess/elec_exp/{pipeline_type}/')
